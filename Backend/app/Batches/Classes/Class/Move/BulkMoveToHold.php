...
class BulkMoveToHold
{
    ...
    public function moveToHold(?Classes $class, ?Trainee $trainees, ?TraineeClass $trainee_class, $class_id, Request $request)
    {
        try
        {
            ...
            $this->notifyUser('has moved trainees from a class to hold list', $this->current_user, 'move_from_class_to_hold');
