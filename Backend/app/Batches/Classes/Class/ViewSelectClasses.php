...
use App\Batches\Helpers\ViewActiveClassesForSelect;

class ViewSelectClasses extends Permissions
{
    use CheckPermissionStatus, GetClasses, ViewActiveClassesForSelect, GetUser, GetClassMeta;
