...
{
    use GetUser, GetGeneralMeta, StoreTraineeEssentialData, StoreTraineeAddtionalData, 
    GetBranch, GetList, CreateMeta, PermissionUniqueness, 
    ...
    public function create(?Trainee $trainee, ?TraineeMeta $TraineeMeta, Request $request)
    {
        try
        {
            ...
            $this->notifyUser('has created a new trainee on the pending list', $this->current_user, 'create_trainees_in_pendinglist');
