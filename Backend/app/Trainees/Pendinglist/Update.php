...
{
    use GetUser, GetGeneralMeta, UpdateTraineeEssentialData, UpdateTraineeAddtionalData, 
    GetBranch, GetList, CreateMeta, UpdateMeta, PermissionUniqueness, 
    ...
    public function update(?Trainee $trainee, ?TraineeMeta $TraineeMeta, Request $request, $id)
    {
        try
        {
            ...
            $this->notifyUser('has updated a trainee on the pending list', $this->current_user, 'update_trainees_in_pendinglist');
