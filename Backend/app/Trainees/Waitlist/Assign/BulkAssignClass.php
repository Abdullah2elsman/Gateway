...
class BulkAssignClass 
{
    ...
    public function bulkAssign(?Trainee $trainee, ?TraineeClass $trainee_class, Request $request)
    {
        ...
        try
        {
            ...
            $this->notifyUser('has assigned trainees to a class', $this->current_user, 'assign_class');
