...
class Refund extends Permissions
{
    ...
    public function __construct($current_user)
    {
        ...
        $this->permission = 'moveWaitToRefund';
    }
    ...
    public function move(?Trainee $trainee, $request)
    {
        ...
        {   
            ...
            $this->notifyUser('has moved trainees from wait list to refund list', $this->current_user, 'move_trainee_from_wait_to_refund');
