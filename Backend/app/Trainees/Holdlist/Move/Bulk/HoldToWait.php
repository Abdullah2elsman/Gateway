...
namespace App\Trainees\Holdlist\Move\Bulk;
...
class HoldToWait extends Permissions
{
    ...
    public function __construct($current_user)
    {
        ...
        $this->permission = 'moveHoldToWait';
    }
    ...
    public function move(?Trainee $trainee, $request)
    {
        ...
        {   
            ...
            $this->notifyUser('has moved trainees from hold list to wait list', $this->current_user, 'move_trainee_from_hold_to_wait');
