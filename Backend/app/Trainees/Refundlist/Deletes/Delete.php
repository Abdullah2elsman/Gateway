...
namespace App\Trainees\Refundlist\Deletes;
...
class Delete extends Permissions
{
    ...
    {
        Gate::authorize('deleteRefundTrainee', $Trainee->find($id));
    ...
    public function delete(?Trainee $trainee, $id)
    {
        try 
        {
            ...
            $this->notifyUser('has deleted a trainee from the refund list', $this->current_user, 'delete_trainees_from_refundlist');
